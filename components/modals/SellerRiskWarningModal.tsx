        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Before You Create an Order...">
            <div className="space-y-5 text-sm text-gray-300">
                <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4">
                    <h3 className="text-lg font-bold text-yellow-400 mb-2">Warning: Risk of Scams</h3>
                    <p className="mb-3">As a seller, you must <span className="font-bold text-white">always verify that you have received the full payment</span> in your own bank or payment app before releasing your crypto.</p>
                ...
                <label className="flex items-start gap-3 cursor-pointer p-3 rounded-xl hover:bg-slate-700/30 transition-colors">
                    <input 
                        type="checkbox" 
                ...
                <div className="flex justify-end gap-3 pt-4">
                    <button 
                        onClick={onClose} 
                        className="py-2.5 px-5 font-bold rounded-xl bg-slate-700/60 border border-slate-600/40 hover:bg-slate-600/80 transition-all duration-200"
                    >
                        Cancel
                    </button>
                    <button 
                        ...
                        disabled={!canConfirm} 
                        className="py-2.5 px-5 font-bold rounded-xl bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-emerald-500/25"
                    >
                        Agree & Create Order
                    </button>
                </div>
